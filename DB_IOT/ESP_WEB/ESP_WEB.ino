...
const char* ssid = "HomeOjo";
const char* password = "0852494177";
const char* SERVER_NAME = "http://panuwatdht.atwebpages.com/sensordata.php";
String PROJECT_API_KEY = "panuwatmysqldht";
